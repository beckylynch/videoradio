    ...
    , ui(new Ui::MainWindow)
{
    ...
    this->setStyleSheet("MainWindow{border-image: url(:/pic/music_menu.jpeg);}");
...
void MainWindow::timerInit()
{
    ...
    //lab2->setGeometry(300,10,488,400);
...
void MainWindow::QListWidget_init()
{
    ...
    songList->setGeometry(0,20,250,385);//设置歌曲列表的位置与大小
...
void MainWindow::labelInit()
{
    ...
    labelSongsTitle->setGeometry(212,416,350,25);//212,416,350,25
    ...
    labelSongsTitle->setText("化作尘音乐 聆听美好！");
    ...
    labelArr[3]->setText("化作尘音乐 聆听美好！");                  //设置歌词文本初始显示内容
...
void MainWindow::lrcArr_init()
{
    ...
    //QString lrcFile = "E:/QTprogram/QT_Vehicle_systems/QMusicPlayer/QMusicPlayer/lrc/ls_cxn.lrc";  //获取文件名以及路径
   // QString lrcFile = "/2039/text/ljj-jj.lrc";
    ...
    if(lrcFile.indexOf("zjl",0)!=-1)//显示写真
        this->setStyleSheet("MainWindow{border-image: url(./pic/zjl.jpeg);}");
    else if(lrcFile.indexOf("ljj",0)!=-1)//显示写真
        this->setStyleSheet("MainWindow{border-image: url(./pic/ljj.jpg);}");
    else
        this->setStyleSheet("MainWindow{border-image: url(:/pic/music_menu.jpeg);}");
